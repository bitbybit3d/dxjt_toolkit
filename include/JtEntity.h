...
#if defined(JT_TOOLKIT_DLL_EXPORT)
    // For the DLL library.
#define JT_TOOLKIT_EXPORT __declspec(dllexport)
#pragma warning( disable : 4251 )
#pragma warning( disable : 4267 )
#elif defined(JT_TOOLKIT_STATIC_IMPORT)
 ...
 */
class JT_TOOLKIT_EXPORT JtEntity
{
protected:
    JtEntity();

private:
    JtEntity(const JtEntity&);              // copy constructor
    JtEntity& operator=(const JtEntity&);   // assignment operator
